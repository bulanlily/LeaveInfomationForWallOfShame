...
public class EmployeeTest {
    ...
    @Before
    public void setUp() {
        employee1 = new Employee(new DateTime(1999, 2, 2, 0, 0),1,"Lily","Beijing");
        //less than 10 days.
    ...
    public void shouldEmployeeEquals() {
        Employee employee2 = new Employee(new DateTime(1999, 2, 2, 0, 0),1,"Lily","Beijing");
    ...
    public void  shouldAddAHistoryLeave(){
        int size = employee1.addHistoryLeaves(new Leave(new DateTime(2012,2,2,0,0),"SICK_LV","sick",4));
        assertEquals(1,size);
    }
